...
$sql = 'SELECT question, answer, `subject` FROM `third_grade` ORDER BY rand() limit 1;';
...
<body>
    ...
    <div class='logo'><h1>3rd Grade - <?php echo $row['subject']; ?></h1></div>
    ...
    <div class="next">
<a href='./fourth.php'><img id='nextUp' src="./images/apple.svg" alt=""></a>
    </div>
