...
$sql = 'SELECT question, answer, `subject` FROM `fourth_grade` ORDER BY rand() limit 1;';
...
<body>
    ...
    <div class='logo'><h1>4th Grade - <?php echo $row['subject']; ?></h1></div>
    ...
    <div class="next">
<a href='./fifth.php'><img id='nextUp' src="./images/apple.svg" alt=""></a>
    </div>
