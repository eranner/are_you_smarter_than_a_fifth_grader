...
$sql = 'SELECT question, answer, `subject` FROM `second grade` ORDER BY rand() limit 1;';
...
<body>
    ...
    <div class='logo'><h1>2nd Grade - <?php echo $row['subject']; ?></h1></div>
    ...
    <div class="next">
<a href='./third.php'><img id='nextUp' src="./images/apple.svg" alt=""></a>
    </div>
